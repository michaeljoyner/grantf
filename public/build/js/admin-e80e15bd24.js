...
},{"./components/Singleupload.vue":39,"./components/Togglebutton.vue":40,"sweetalert":10,"vue":36,"vue-resource":25}],39:[function(require,module,exports){
            ...
            this.$http.post(this.url, fd, {
                upload: {
                    onprogress: function onprogress(ev) {
                        _this.showProgress(parseInt(ev.loaded / ev.total * 100));
                    }
                }
            }).then(function (res) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/mooz/work/grantf/resources/assets/js/components/Singleupload.vue"
...
},{"vue":36,"vue-hot-reload-api":11,"vueify-insert-css":37}],40:[function(require,module,exports){
var __vueify_style__ = require("vueify-insert-css").insert("\n\n")
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"btn gf-btn btn-light\" v-bind:class=\"{ 'btn-clear-danger': state, 'btn-light': !state}\" v-on:click=\"toggleState\">\n    {{ buttonText }}\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/mooz/work/grantf/resources/assets/js/components/Togglebutton.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n\n"] = false
    document.head.removeChild(__vueify_style__)
  })
